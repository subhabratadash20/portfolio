    ...
    <main>
      ...
      <section className="hero" id="hero">
        <div className="hero-content">
          ...
          {/* Social Links */}
          <div className="hero-social-links animate-on-scroll">
            <a href="https://github.com/subhabratadash20" target="_blank" rel="noopener noreferrer" className="hero-social-link" aria-label="GitHub">
            ...
            <a href="https://linkedin.com/in/subhabratadash" target="_blank" rel="noopener noreferrer" className="hero-social-link" aria-label="LinkedIn">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            <span className="hero-social-divider" />
            <a href="https://x.com/subhabrata91463" target="_blank" rel="noopener noreferrer" className="hero-social-link" aria-label="Twitter / X">
        ...
        <div className="container">
          ...
          <div className="projects-grid">
            {projects.map((project) => (
              <article key={project.slug} className="project-card glass-card animate-on-scroll" data-tilt="true" data-slug={project.slug}>
                <div className="project-image">
                  {/* Animated gradient mesh background */}
                  <div className="project-image-mesh" />
                  <div className="project-overlay"></div>
                  {/* Floating icon placeholder */}
                  <div className="project-placeholder">
                    {projectPlaceholders[project.slug]}
                  </div>
                  {/* Subtitle label at bottom of image */}
                  <div className="project-image-label">
                    <span className="project-image-label-emoji">{project.emoji}</span>
                    <span className="project-image-label-text">{project.subtitle}</span>
                  </div>
                </div>
      ...
      <section className="cta-banner">
        ...
        <div className="cta-banner-borders" />
        <div className="cta-banner-content">
          <div className="cta-banner-eyebrow animate-on-scroll">
            <span className="cta-banner-eyebrow-dot"></span>
            Open to Opportunities
          </div>
          <h2 className="animate-on-scroll">Let&apos;s Build Something Amazing</h2>
          <p className="animate-on-scroll">
            From AI-powered apps to real-time platforms — I bring ideas to life with precision,
            passion, and pixel-perfect attention to detail.
          </p>
          <div className="cta-banner-actions animate-on-scroll">
            <a href="mailto:subhabratadash2@gmail.com" className="btn btn-primary">
        ...
        <div className="container">
          ...
          <div className="contact-content">
            ...
            <div className="contact-links animate-on-scroll">
              ...
              <a href="https://github.com/subhabratadash20" target="_blank" rel="noopener" className="contact-card glass-card contact-card--github">
                <div className="contact-icon">
              ...
              <a href="https://x.com/subhabrata91463" target="_blank" rel="noopener" className="contact-card glass-card contact-card--twitter">
                <div className="contact-icon">
                ...
                <span className="contact-value">Follow me</span>
              </a>
      ...
      <footer className="footer">
        <div className="container">
          ...
          <div className="footer-social-links">
            <a href="https://github.com/subhabratadash20" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="GitHub">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
              </svg>
            </a>
            <a href="https://linkedin.com/in/subhabratadash" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="LinkedIn">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
              </svg>
            </a>
            <a href="https://x.com/subhabrata91463" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Twitter / X">
